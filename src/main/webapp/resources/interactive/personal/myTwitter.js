	   ...
	   $(".forward_btn").click(function(){
		...
		function updateComments(commentDtos,$comment){
			   ...
			   if(commentDtos.length>=5){
				   var more="<a href='j/weibo/common/singleTwitter?twitterId="+twitterId+"'><li class='CommentButtom'><span class='CommentButtomA'>更多</span></li></a>";
		...
		$(".page_selector").click(function(){
		    ...
		    location.href="/weibo/personal/myTwitterList?pageNum="+pageNum;	
		});
