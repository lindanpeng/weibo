		...
		<div class="head">
			...
			<div class="profile_data">
				<ul class="nav nav-tabs">
					<li><a href="javaScript:void(0)" id="toHisConcernedUserList">关注<span>${checkedUser.concernedUserAmount}</span></a></li>
					<li><a href="javaScript:void(0)" id="toHisFanList">粉丝<span>${checkedUser.fanAmount}</span></a></li>
					<li><a href="javaScript:void(0)" id="toHisTwitterList">动态<span>${checkedUser.twitterAmount}</span></a></li>
				</ul>
			</div>
		</div>
		<div class="content">
...
未知
	...
	<script
		src="<%=request.getContextPath()%>/resources/interactive/personal/hisInformation.js"></script>
	<script
