...
<body>
	...
	<input type="hidden" value="${userDto.user.userId}" id="userId">
		<input type="hidden" value="${userDto.user.nickname}" id="nickname">
	<form action="<%=request.getContextPath()%>/personal/publishTwitter"
	...
	<script
		src="<%=request.getContextPath()%>/resources/interactive/personal/home.js"></script>
	<script
