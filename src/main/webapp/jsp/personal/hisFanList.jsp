...
<c:set var="FOLLOWED_TEXT" value="相互关注" />
...
<title>${checkedUser.user.nickname}的粉丝</title>
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/bootstrap.min.css">
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/hisFanList.css">
</head>
<body>
	...
	<script
		src="<%=request.getContextPath()%>/resources/interactive/personal/hisFanList.js"></script>
	<script
