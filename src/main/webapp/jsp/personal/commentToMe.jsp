...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/commentToMe.css">
</head>
<body class="bgBody">
		...
		<div class="bigcon1">
			...
			<div class="leftCon" id="left_con">
				<ul class="nav nav-pills nav-stacked">
					...
					<li><a href="<%=request.getContextPath()%>/personal/commentToMe" class="topfontChosen "><font
							face="微软雅黑" size="3.5"><span><img
			...
			<div class="rightCon" id=right_con>
				<ul class="list-group">
					...
					<li class="list-group-item-head"><span
						style="top: 0.2em; position: relative; left: 0.4em"> <!-- <font size="3.5">&nbsp;收到的赞</font></span> -->
							<div class="received">
								<a href="<%=request.getContextPath()%>/personal/commentToMe">收到的评论</a><img
									class="downPng"
									src="<%=request.getContextPath()%>/resources/img/down.png">
							</div>
							<div class="emitted">
								<a href="<%=request.getContextPath()%>/personal/commentFromMe">发出的评论</a>
							</div>
					...
					<c:forEach var="commentDto" items="${pagerResult.resultSet}">
						<li class="list-group-item setHeight"><input type="hidden"
							class="comment" userId="${commentDto.fromUser.userId}"
							...
							<div class="content_follow">
								...
								<a class="formal"
									...
									${commentDto.twitter.textContent eq ''?'分享图片':commentDto.twitter.textContent}
								</a>
							</div>
							<div class="data">
	...
	<script
		src="<%=request.getContextPath()%>/resources/interactive/personal/commentToMe.js"></script>
</body>
</html>