...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/twitterAtMe.css">
</head>
<body class="bgBody">
		...
		<div class="bigcon1">
			...
			<div class="leftCon" id="left_con">
				<ul class="nav nav-pills nav-stacked">
					<li><a
						href="<%=request.getContextPath()%>/personal/atMeTwitters"
						class="topfontChosen "><font face="微软雅黑" size="3.5"><span><img
									src="<%=request.getContextPath()%>/resources/img/concern.png"></span>@我的微博</font></a></li>
			...
			<div class="rightCon" id="right_con">
				<ul class="list-group">
					...
					<li class="list-group-item-head clearListStyle"><span
						style="top: 0.2em; position: relative; left: 0.4em"> <font
							size="3.5">&nbsp;@我的微博</font></span>
						<div class="triangle"></div></li>


					<li class="clearListStyle"><c:if
							test="${fn:length(pagerResult.resultSet)==0}">
						...
						</c:if> <c:forEach var="twitterDto" items="${pagerResult.resultSet}">
					...
					<li class="list-group-item Page1"><c:if
							...
							<div style="color: #5f5f5f; text-align: center;">已全部加载完</div>
						</c:if></li>
	...
	<script
		src="<%=request.getContextPath()%>/resources/interactive/personal/twitterAtMe.js"></script>
</body>
</html>